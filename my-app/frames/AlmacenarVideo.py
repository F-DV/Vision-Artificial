...
while(Video.isOpened()):
  ...
  if ret == True:
    ...
    cv2.imwrite('/home/felipeqg/Documents/Vision-Artificial/assets/videos/rinos_'+str(Frames_number)+'.jpg',Color)
...
skvideo.io.vwrite("/home/felipeqg/Documents/Vision-Artificial/assets/videos/rhinos.avi", Stack)#Ruta y nombre para guardar
Video.release()
